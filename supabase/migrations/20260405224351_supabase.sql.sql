...
-- Projects RLS
CREATE POLICY "Buyers can insert own projects" ON public.projects
...
CREATE POLICY "Buyers can view own projects" ON public.projects
    FOR SELECT USING (
        EXISTS (
            SELECT 1
            FROM public.buyers b
...
CREATE POLICY "Buyers can update own projects" ON public.projects
    FOR UPDATE USING (
        EXISTS (
            SELECT 1
            FROM public.buyers b
